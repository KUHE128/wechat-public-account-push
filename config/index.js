export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3b2a1a16989c278b",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "49d57b37e47b3763a2ddbce323b2ca08",
  ...
  USERS: [
    {
      ...
      id: "oPN-K5pTpgYIFBbW3qP6cvlXdAGI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "xTKBRg3jJ7bNHAErhHcFvNbCnE7CmZ3rJW_p2IqBQC8",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "贵阳",
